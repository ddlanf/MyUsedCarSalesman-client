                ...
                <section className="make-post-form-box">
                    <form className="make-post-form">
                        ...
                        <div className="make-post-right">
                            ...
                            <label htmlFor="img" className="img make-post-label">Select images:</label>
                            <input type="file" id="img" name="img" accept="image/*" className="make-post-img make-post-input"/>
                        </div>
